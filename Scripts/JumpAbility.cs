...
namespace Bimicore.BSG.ThirdPerson
{
	public class JumpAbility : MovementInAirAbstractAbility, IState
	{
		...
		[SerializeField] private bool customLowJumpFallAcceleration = false; // Used only to expand Inspector
		[EnableIf ("customLowJumpFallAcceleration")]
		...
		{
			if (!customLowJumpFallAcceleration)
		...
		public bool IsFreeAboveToJump() => environmentScanner.IsFreeAbove(minJumpHeight);
